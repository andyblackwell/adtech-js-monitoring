(function(E) {
	...
	var Ga = function(a, b) {
			...
			var c = a[3] || "";
			return new x(Ca, a[1] + Fa("?", a[2] || "", b) + Fa("#", c, void 0));
		},
		y = function(a) {
	...
	var Va = function(a) {
			return a instanceof z && a.constructor === z && a.g === Ua
				? a.c
				: "type_error:SafeUrl";
		},
	...
	var $a = function(a) {
			return a instanceof B && a.constructor === B && a.i === Za
				? a.c
				: "type_error:SafeHtml";
		},
		ab = function(a) {
		...
		gb = function(a) {
			...
			q(a, e);
			return C(d.join($a(b).toString()), c);
		},
		db = function(a) {
	...
	var $b = function(a, b) {
		...
		dc = function(a) {
			var b = M.f().a;
			if (b) {
				var c = wa(J(a, Yb, 5), function(d) {
					return Sb(I(d, K, 1), b);
				});
				if (c) return I(c, Vb, 2);
			}
			return I(a, Vb, 4);
		},
		fc = function() {
	...
	var gc = function(a, b, c) {
		...
		nc = function() {
			return r(Object.keys(fc.f().a), function(a) {
				return Number(a);
			});
		},
		oc = function(a) {
			t(fc.f().b, a) || kc(cc(4), a);
		};
	var N = function(a) {
			this.a = a;
		},
	...
	var Qc = [12, 13],
		...
		Vc = function(a, b) {
			...
			if (f) {
				...
				b = Zc(b, e);
				return !b || (c && !Sb(I(b, K, 3), c)) ? null : $c(a, [b], 1);
			}
			d = c
				? ua(d, function(g) {
						return Sb(I(g, K, 3), c);
	...
	var kd = /^\.google\.(com?\.)?[a-z]{2,3}$/,
		ld = /\.(cn|com\.bi|do|sl|ba|by|ma|am)$/,
		md = function(a) {
			return kd.test(a) && !ld.test(a);
		},
		nd = function(a) {
		...
		if (!ud.o()) {
			var a = h.document,
				b = function(e) {
					...
					ib(f, e);
					try {
						(a.head || a.body || a.documentElement).appendChild(f), ud.A();
					} catch (g) {}
				},
				c = W[1];
			b(c);
	...
	var wd = function(a) {
		...
		xd = function(a, b, c) {
			...
			pd();
			1 == c ? a.K() : a.J();
			if (!d && a.N()) md(".google.com") && (W[1] = ".google.com"), a.s();
			else {
	...
	var X = h.performance,
		...
		Cd = u(function() {
			var a;
			if ((a = Bd)) (a = Lb()), (a = !!a.indexOf && 0 <= a.indexOf("1337"));
			return a;
		});
	...
	Dd.prototype.i = function(a, b, c, d, e) {
		c = void 0 === c ? this.c : c;
		e = void 0 === e ? this.g : e;
		if (Math.random() > c) return !1;
		(b.error && b.meta && b.id) || (b = new Jb(b, { context: a, id: e }));
	...
	var Gd = w("gpt/pubads_impl_"),
		Hd = w("https://securepubads.g.doubleclick.net/"),
		Id = w("https://ff.doubleclick.net");
	var Jd = function(a) {
	...
	var Y = function() {
			...
			this.R = !1;
			this.w = Md(641, this.w.bind(this));
		},
		Pd = function() {};
	Y.prototype = da(Pd.prototype);
		...
		for (var Qd in Pd)
			if ("prototype" != Qd)
				if (Object.defineProperties) {
					var Rd = Object.getOwnPropertyDescriptor(Pd, Qd);
					Rd && Object.defineProperty(Y, Qd, Rd);
				} else Y[Qd] = Pd[Qd];
	var Sd = function() {
		var a = new Y();
		a.O.observe({
	...
	var ce = [],
		ee = function(a) {
			a = de(new Oc(T(246)), new Oc(a || ce));
			var b = be.f();
			b[3][6] = function(c) {
				return t(Q.f().b(), parseInt(c, 10));
			};
			id(a, b);
		},
		de = function(a, b) {
	...
	var fe = function() {
		var a =
			void 0 === a
				? Ha([Id, w("/tag/js/fetch_frame_"), w("2019111801"), w(".html")])
				: a;
		var b = rb();
	...
	var ge = function(a) {
		...
		he = function() {
			...
			a = Ha([Hd, Gd, a, w("2019111801"), w(".js")]);
			var b = ed();
		...
		ie = function(a, b) {
			...
			Q.f().a(12);
			Q.f().a(5);
			S(200) || S(220) || ((b = T(150)), pd(), md(b) && (W[1] = b));
		},
		je = function(a, b, c) {
			var d = Td();
			a = a || d.fifWin || window;
			...
			if (d.evalScripts) d.evalScripts();
				...
				if (ge(b)) {
					...
					b.getElementById(f) && ((d._loadStarted_ = !0), c || zd());
				}
				if (!d._loadStarted_) {
					c || yd();
	...
	(function(a, b, c) {
		var d = new Dd(null, "gpt_exception", 0.01);
		Ed(d, function(e) {
			e.methodId = 420;
		});
		Fd(d, function() {
	...
	[
		...
		[
			...
			[
				...
				[
					...
					[
						[21065127],
						[21065128, [[null, 32, null, [null, 5]]]],
						[21065129, [[null, 32, null, [null, 10]]]],
						[21065130, [[null, 32, null, [null, 15]]]],
						[21065131, [[null, 32, null, [null, 30]]]]
					]
				],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21065161]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21065161]]
							],
		...
		[
			...
			[
				...
				[
					50,
					[[21065167], [21065168, [[159, null, null, []]]]],
					[2, [[4, null, 12]]],
					16
				]
			]
		...
		[11, [[1, [[21065145], [21065146, [[255, null, null, [1]]]]]]]]
	]
]));
