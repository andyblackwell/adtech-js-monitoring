/*1535420495,,JIT Construction: v4253400,en_US*/
				...
				with (this) {
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h) {
							...
							function w(a) {
								v(a) && (a = a.ownerDocument.defaultView.frameElement);
							...
							e.exports = {
								calculateLargestMargin: H,
								cssSize: t,
								extractOrigin: m,
								extractDomain: a,
								extractHostname: n,
								findWidestParentElement: G,
								getDFPRoot: w,
								getElementWidth: x,
								getElementHeight: y,
								getScreenHeight: A,
								...
								isSameRootDomain: b,
								maybeHTMLElement: q,
								maybeHTMLBodyElement: r,
								once: L,
								resizeElement: u,
								restoreElementStyles: E,
								removeStoredData: F,
								screenIsPortrait: B,
								storeElementStyles: D,
								truncateTextToFitElement: K
							};
						},
						null
					);
					...
					__d(
						...
						function(a, b, c, d, e, f, g) {
							...
							e.exports = { anchor: b, dom: h, div: a, find: c };
						},
						null
					);
					__d(
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h, i, j, k, l) {
							...
							a.prototype.$20 = function() {
								var a = new h(
									this.$6,
									this.$5.adChoicesHref,
									function(a) {
										(this.$11 = a), this.onInitialStepDone();
									}.bind(this),
									function() {
										this.$8(), this.$14();
									}.bind(this)
							...
							a.prototype.render = function() {
								(this.$4 = document.createElement("a")),
									(this.$4.href = "#"),
									(this.$4.className = "_6qhg" + (this.$12 ? " _6r2w" : "")),
									(this.$2 = m("_6qhh", [this.$4])),
									this.$4.addEventListener(
										"click",
										function(a) {
											a.preventDefault(), this.$20(), this.$7();
										}.bind(this)
									),
									this.$1.appendChild(this.$2);
							};
					...
					__d(
						...
						function(a, b, c, d, e, f) {
							...
							function a(a) {
								__p && __p();
								if (g()) return k() ? l.CHROME_MAC : l.CHROME_WIN;
								else if (h()) {
									var b = a.screen,
										c = b.height;
									b = b.width;
									...
									return k()
										...
										: d
											? l.FIREFOX_WIN_MAX
											: l.FIREFOX_WIN;
								} else if (j()) return l.IE_11;
								else if (i()) return l.SAFARI;
								else return 0;
							}
							e.exports = {
								getBrowserBarOffset: a,
								getChromeVersion: g,
								getFirefoxVersion: h,
								getSafariVersion: i,
								isIE11: j
					...
					__d(
						...
						function(
							...
							function a(a) {
								...
								var b = s.getTopMostAccessibleWindow();
								b =
									(b.performance &&
										b.performance.timing &&
										b.performance.timing.navigationStart) ||
									0;
								this.$29 = new r(y.ERROR, a.tagJsInitTime, b, this.sendSignal);
								this.$11 = a.rootElement;
								this.$15 = new w(this.$11, this.$33());
								this.$2 = null;
								this.$4 = !1;
								o.add(
									window,
									"pagehide",
									function() {
										this.$4 || this.$29.event("ADNW_UNLOAD_BEFORE_ADLOADED");
									}.bind(this)
								);
								this.$26 = new A();
								this.$30 = new q(this.$11);
							}
							...
							a.prototype.$34 = function() {
								return this.$33().frameElement;
							};
							a.prototype.$35 = function(a) {
								a = a.ownerDocument;
							...
							a.prototype.$38 = function(a) {
								...
								var b = this.$37();
								if (this.$36()) {
									var c = !!this.$13.inlineXOutCondensed,
										d;
									if (!c) {
										var e = new k(b, a);
										d = e.render();
									}
									var f = c ? "inline-condensed" : "inline";
									e = new v(
										b,
										a,
										this.$31,
										s.once(
											function() {
												this.$29.event("ADNW_XOUT_START", f);
											}.bind(this)
										),
										s.once(
											function() {
												this.$29.event("ADNW_XOUT_CANCEL", f);
											}.bind(this)
										),
										function(a) {
											this.sendToFacebook("xout", {
												reason: a ? a.option_type : null,
												type: f
											}),
												this.$29.event("ADNW_XOUT_END", f);
										}.bind(this),
										c
									);
									e.render();
									this.$17 &&
										!this.$18 &&
										((e.getButton().style.marginTop = "7px"),
										d && (d.style.marginTop = "7px"));
									c && this.$17 && (e.getButton().style.top = "2px");
									return;
								}
								c = new j(b, a);
								c.render();
							...
							a.prototype.adLoaded = function(a, b, c, d) {
								__p && __p();
								if (this.$4) {
									this.$29.error("Multiple ADLOADED attempted.");
									return;
								}
								this.$14 = a.flags || [];
								this.$13 = a.features || {};
								this.$29.setLogLevel(this.$13.logLevel || y.ERROR);
								this.$29.setClientEventURL(a.clientEventURL);
								this.$12 = a.enableWhiteops;
								this.$16 = a.isDesktopDisplayFormat;
								this.$1 = E();
								this.$4 = !0;
								this.$31 = a.xout;
								this.$32 = !!this.$13.inlineXOut;
								this.$23 = {};
								if (!a.success) {
									this.$29.error();
								...
								this.$22 = C.appendToUrl(a.nativeImpURL, {
								...
								this.$37().classList.add("fbAdLoaded");
								c(a.placementId);
								a.resizeMediaView
									? window.setTimeout(
											function() {
												...
												var c = new p(
													...
													d = this.$37();
												d.style.width = s.cssSize(this.$19);
												this.$6 && this.$6.ensureSizes();
												d = c.resize(this.$19, d.offsetHeight);
												d &&
													((this.$17 = !0), (this.$18 = !!a.nativeCarouselAds));
												this.$38(a.nativeAd);
												if (f) {
													var g = function() {
									...
									: this.$38(a.nativeAd);
								d = this.setupViewability();
								this.$23.viewability = d.viewabilityLevels.join(",");
								this.$23.width_in_view = d.widthInView || 0;
								this.$23.height_in_view = d.heightInView || 0;
								this.$23.left = d.pageLeft || 0;
								this.$23.top = d.pageTop || 0;
								this.$23.scroll_left = d.scrollLeft || 0;
								this.$23.scroll_top = d.scrollTop || 0;
								this.$23.page_width = d.pageWidth || 0;
								this.$23.page_height = d.pageHeight || 0;
								this.$29.eventWithParams("ADNW_ADLOADED", this.$23);
								this.$44();
								this.$45();
							};
							a.prototype.$45 = function() {
								if (this.$13.forceIframeSize != null) {
									var a = this.$13.forceIframeSize,
										b = this.$34();
									b &&
										((b.style.width = s.cssSize(a.w)),
										(b.style.height = s.cssSize(a.h)));
								}
							};
							a.prototype.$44 = function() {
								...
								for (var b = 0; b < a.length; b++)
									s.truncateTextToFitElement(a[b]);
							};
							a.prototype.$42 = function() {
								var a = 300,
									b = s.getScreenWidth(),
									c = this.$34() || this.$11;
								c = s.findWidestParentElement(c);
								var d = s.calculateLargestMargin(c);
								this.$19 = b - d * 2;
								this.$19 < a &&
									((this.$19 = a), (d = c.getBoundingClientRect().right - a));
								return d;
							};
							a.prototype.$40 = function() {
								...
								c.style.border = "0";
								c.style.width = s.cssSize(b);
								c.style.height = s.cssSize(a);
								this.$11.appendChild(c);
								b = F(c.contentDocument.body);
								b.style.overflow = "hidden";
								b.style.margin = "0";
								b.style.padding = "0";
								b.style.maxWidth = s.getScreenWidth() + "px";
								this.$8 = b;
								this.$9 = c;
							};
							a.prototype.$41 = function() {
								...
								b.style.maxWidth = s.cssSize(s.getScreenWidth());
								b.style.width = "100%";
							...
							a.prototype.loadCreative = function(a, b, c, d, e) {
								(a.nativeAd.loaded = !1),
									...
									c && ((c = this.$37()), this.$35(c)),
									(this.$25 = a.nativeAd && c ? c : d),
									(this.$21 = this.loadNativeAd(
										c,
										a.nativeAd,
										a.nativeCarouselAds,
										e,
							...
							a.prototype.adjustMediaViewSize = function(a, b) {
								...
								s.resizeElement(b, this.$19, Math.round(this.$19 / a));
							};
							...
							a.prototype.setupViewability = function() {
								...
								this.$27 || a.mediaLoaded();
								this.$26.addBehavior(a);
								this.$28.addListener(function() {
									return a.mediaLoaded();
								});
								return this.$24.getCurrentViewabilityState();
							};
							...
							a.prototype.loadMedia = function(a, b, c, d, e, f) {
								d
									? this.loadCarousel(b, d, f)
									: c.adVideo
										? this.loadVideo(b, c, e)
										: this.loadImage(b, c);
							};
							a.prototype.loadCarousel = function(a, b, c) {
								__p && __p();
								this.$27 = !0;
								var d = new m({
									parent: a,
									...
									onEvent: function(a, b) {
										switch (a) {
											case "AN_CAROUSEL_EVENT_SWIPE":
												this.$29.eventWithParams("CAROUSEL_SWIPE", b);
										}
									}.bind(this),
									onLoadEventCounter: this.$28
								});
								a.appendChild(d.getElement());
								d.ensureSizes();
								d.getLinks().forEach(
									function(a, d) {
										this.installLink(a, b[d], c);
									}.bind(this)
								);
								this.$6 = d;
							};
							...
							a.prototype.loadVideo = function(a, b, c) {
								...
								var d = new u(
									F(b.adVideo),
									b.adImage,
									this.$13.videoBlendedBackground,
									function() {
										this.$28.requiredEventFired();
									}.bind(this),
									function() {
										return this.$29.event("PLAY_FAILED");
									}.bind(this),
									function() {
										return this.$29.event("VIDEO_CLICK");
									}.bind(this)
								);
								this.$26.addBehavior(new B(d, c));
								new t(
									d.getVideoElement(),
									this.sendSignal,
									b.videoPlayLink,
							...
							a.prototype.installLink = function(a, b, c) {
								__p && __p();
								var d = function(event) {
									...
									var a = event,
										...
										f = b.clickReportURL,
										g = {},
										h = this.$13.minClickDelay;
									if (h && this.$1 && this.$1 + h > d && !this.$3) {
										this.$3 = !0;
										this.$29.event("ADNW_FAST_CLICK", "" + (d - this.$1));
										a.preventDefault();
										a.stopPropagation();
										return;
									}
									if (this.$24) {
										h = this.$24.getDimensions();
										var i = this.$24.getCurrentViewabilityState(),
											j = {};
										if (h != null) {
											j.height = h.height;
											j.width = h.width;
											if (i.widthInView != null && i.heightInView != null) {
												j.visibleWidth = Math.round(i.widthInView * h.width);
												j.visibleHeight = Math.round(i.heightInView * h.height);
												h = h.height * h.width;
												h && (g.vp = (j.visibleWidth * j.visibleHeight) / h);
											}
										}
										this.$15.getSafeFrameAPI()
											? ((j.relClickX = a.clientX), (j.relClickY = a.clientY))
											: ((j.clickX = a.clientX),
											  (j.clickY = a.clientY),
											  i.viewportLeft != null &&
													i.viewportTop != null &&
													((j.relClickX = a.clientX - i.viewportLeft),
													(j.relClickY = a.clientY - i.viewportTop)));
										g.clktm = Math.round(d / 1e3);
										this.$2 == null
											? this.$29.event(
													"ADNW_NON_VIEWABLE_CLICK",
													this.$15.getTopURL() || this.$15.pageDomain
											  )
											: (g.clkdel = d - this.$2);
										g.touch = JSON.stringify(j);
									}
									g.clknutab = c;
									if (f) {
										h = C.appendToUrl(f, g);
									...
									i = s.isAppStoreURL(e);
									c && e && !i && this.$30.openNewTab(e);
									if (c || i) {
										d = new l(window.document);
										var k = E();
										d.onBounceBack(
											function(a) {
												this.sendToFacebook("bounce", {
													...
													this.$29.event("ADNW_BOUNCEBACK", "" + a);
											}.bind(this)
										);
									}
									a.preventDefault();
								...
								var e = this.$8.querySelector(".adnwTwoClickBlocker");
								if (e && !!this.$13.clickConfirmation) {
									var f = F(e.querySelector(".adnwCancelLink"));
									o.add(f, "click", function(event) {
										e.style.display = "none";
									});
									f = F(e.querySelector(".adnwContinueLink"));
									o.add(f, "click", function(event) {
										(e.style.display = "none"), d(event);
									});
									o.add(a, "click", function(event) {
										e.style.display = "block";
									});
								} else o.add(a, "click", d);
							};
							...
							a.prototype.$43 = function(a, b, c, d) {
								__p && __p();
								this.$24.pause();
								a.nativeAd.loaded = !1;
							...
							a.prototype.$48 = function(a, b, c, d, e, f, g) {
								b.loaded = !0;
								var h;
								d = a.getElementsByClassName("fbAdIcon");
								for (h = 0; h < d.length; h++)
									d[h].appendChild(this.createAdIcon(b));
								this.$20 = a.getElementsByClassName("fbAdMedia");
								for (h = 0; h < this.$20.length; h++)
							...
							a.prototype.loadNativeAdInternal = function(
								a,
								b,
								c,
								d,
								...
								var i,
									j = a.getElementsByClassName("fbAdIcon" + d);
								for (i = 0; i < j.length; i++)
									j[i].appendChild(this.createAdIcon(b));
								j = !1;
								this.$20 = a.getElementsByClassName("fbAdMedia" + d);
								for (i = 0; i < this.$20.length; i++)
									(j = !0),
										e && !c && this.adjustMediaViewSize(b, this.$20[i]),
										this.loadMedia(a, this.$20[i], b, c, g, h);
								this.updateAdText(a, b, d, f, h);
								return j;
							};
							a.prototype.updateAdText = function(a, b, c, d, e) {
								__p && __p();
								var f;
								d = a.getElementsByClassName("fbAdTitle" + c);
								for (f = 0; f < d.length; f++) d[f].textContent = b.adTitle;
								d = a.getElementsByClassName("fbAdSubtitle" + c);
								for (f = 0; f < d.length; f++) d[f].textContent = b.adSubtitle;
								d = a.getElementsByClassName("fbAdBody" + c);
								for (f = 0; f < d.length; f++) d[f].textContent = b.adBody;
								d = a.getElementsByClassName("fbAdCallToAction" + c);
								for (f = 0; f < d.length; f++)
									d[f].textContent = b.adCallToAction;
								d = a.getElementsByClassName("fbAdSocialContext" + c);
								for (f = 0; f < d.length; f++)
									d[f].textContent = b.adSocialContext;
								d = a.getElementsByClassName("fbAdLink" + c);
								for (f = 0; f < d.length; f++) this.installLink(d[f], b, e);
							};
								...
								b.addEventListener(
									...
									function() {
										this.$28.requiredEventFired(),
											b.naturalWidth === 1 &&
												b.naturalHeight === 1 &&
												this.$29.eventWithParams("ADNW_ADERROR", {
							...
							a.prototype.$39 = function() {
								return !this.$34() && !this.$49() && G[this.$10];
							};
							a.prototype.$47 = function() {
								this.$37().classList.add("fbVisibleOnce");
								var a = this.$24.getCurrentViewabilityState(),
									b = this.$24.getDimensions();
								b = this.$50(b, a);
								this.sendImpression(
									C.appendToUrl(this.$22, b),
									this.$23,
									F(this.$1)
								);
							};
							a.prototype.$50 = function(a, b) {
								var c = {
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"4253400","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
