/*1560453899,,JIT Construction: v1000826497,en_US*/
				...
				with (this) {
					...
					__d("JSSDKCssConfig", [], {
						...
						components: [
							...
							"css:ANWebTitleAndBodyPauseCard",
					...
					__d(
						"ANCarouselItem",
						["csx", "cx", "VPAIDDomUtils", "joinClasses", "nullthrows"],
						function(a, b, c, d, e, f, g, h) {
							...
							a = (function() {
								...
								c.$7 = function() {
									...
									var a;
									this.$5 === "Empty"
										? (a = b("joinClasses")("_11vk", "fbAdCallToAction"))
										: (a = b("joinClasses")("_11vk _7m01", "fbAdCallToAction"));
									a = this.$6
										? l("_11u9", [i("_7-fv _7-fm _11ur", [i("_7-fm _11us")])])
										: l("_11u9", [
												i("_11ur", [
													i("_11us"),
													i("_11u-", [
												...
												m(a, b("nullthrows")(this.$1.adCallToAction))
										  ]);
									this.$3 = k(a, "._11us");
									var c = this.$4;
									if (c != null) {
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h) {
							...
							c = (function() {
								...
								c.$19 = function() {
									return this.$14 ? this.$10 - s : Math.round(this.$10 * o);
								};
								c.$20 = function() {
									return this.$14 ? r : Math.round(this.$8 * p);
								};
								c.$21 = function() {
									return this.$8 > n ? q : 1;
								};
								...
								c.getFullWidth = function() {
									var a = this.$4.length * (this.$8 + this.$9);
									return this.$14 ? a + r : a;
								};
								...
								c.ensureSizes = function() {
									...
									this.$8 = this.$19();
									this.$9 = this.$20();
									this.$1.style.fontSize = this.$21() * 100 + "px";
									...
									ES(this.$5, "forEach", !0, function(b, c) {
										...
										c === 0 &&
											(d.style.marginLeft = (a.$14 ? a.$9 + r : a.$9) + "px");
									});
								};
								return a;
							})();
								...
								c.$17 = function(a, b) {
									...
									d.addEventListener("load", function() {
										(a.style.backgroundImage = "url(" + b + ")"),
											c.$8 || ((c.$8 = !0), c.$3.requiredEventFired());
									});
									d.src = b;
								};
								c.getElement = function() {
							...
							a = (function() {
								...
								function a(a, c, d, e) {
									(this.$1 = new (b("ANStyleChangeTracker"))()),
										...
										(this.$4 = d),
										(this.$5 = e),
										(this.$6 = this.getAdHeight()),
										(this.$7 = b("ANUtils").getElementWidth(this.$8()));
								}
								var c = a.prototype;
								c.$8 = function() {
									return this.$2 ? this.$2 : this.$3;
						...
						function(a, b, c, d, e, f) {
							...
							a = (function() {
								...
								c.logMRCEvent = function(a, c, d, e, f, g) {
									f = this.$10(c, d, e, a);
									this.$11(b("AdNetworkVideoEventType").VIDEO_MRC, f);
								};
								...
								c.logTimeEvent = function(a, c, d, e, f, g, h) {
									f = this.$10(a, c, d, e);
									this.$11(b("AdNetworkVideoEventType").VIDEO_TIME, f);
									h();
								};
								c.logMuteEvent = function() {
									if (!this.$2.isMuted()) return;
									this.$12(b("AdNetworkVideoEventType").VIDEO_MUTE);
								};
								c.logUnMuteEvent = function() {
									if (this.$2.isMuted()) return;
									this.$12(b("AdNetworkVideoEventType").VIDEO_UNMUTE);
								};
								c.$9 = function() {
									this.$12(b("AdNetworkVideoEventType").VIDEO_PAUSE);
								};
								c.$8 = function() {
									this.$12(b("AdNetworkVideoEventType").VIDEO_UNPAUSE);
								};
								c.$12 = function(a) {
							...
							a = (function() {
								...
								c.$6 = function() {
									var a = h("_82tm"),
										...
										d = h("_82tp fbAdLink", [
											h("_82tq"),
											h("_82tr", [a, h("_82ts"), b, c])
										]);
									c.addEventListener("click", this.$7);
									a.addEventListener("click", this.$8);
									return [d, a, b, c];
								};
								c.attach = function(a) {
									...
									a = a.getVideoElement();
									a.addEventListener("timeupdate", this.$9);
									this.$10();
								};
								c.detach = function() {
									...
									if (a) {
										a = a.getVideoElement();
										a.removeEventListener("timeupdate", this.$9);
									}
								};
								c.$10 = function() {
					...
					__d(
						...
						function(a, b, c, d, e, f, g) {
							...
							a = (function() {
								...
								var c = a.prototype;
								c.$4 = function() {
									var a = h(b("joinClasses")("_7w_p", "fbAdLink"), [
											h("fbAdTitle"),
											h("fbAdBody")
										]),
										c = h("_7w_q");
									a = h("_7w_r", [c, h("_7w_s", [a])]);
									c.style.backgroundImage = "url(" + this.$1 + ")";
									return a;
								};
								c.attach = function(a) {
								...
								c.detach = function() {
									this.$2.parentNode && this.$2.parentNode.removeChild(this.$2),
										this.$2.removeEventListener("click", this.$5);
								};
								return a;
							})();
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h) {
							...
							function o(a, c) {
								...
								if (a === "title_and_body")
									return new (b("ANWebTitleAndBodyPauseCard"))(c);
								return a === "vertical"
						...
						function(a, b, c, d, e, f, g) {
							...
							a = (function() {
								...
								c.setOverlayBackgroundColor = function(a) {
									b("nullthrows")(this.$15()).style.setProperty(
										"background",
										a
									);
								};
						...
						function(a, b, c, d, e, f) {
							...
							a = (function(a) {
								...
								d.onPartiallyLeft = function() {
									(this.$AdStatsBehavior3 +=
										b("getTime")() - this.$AdStatsBehavior6),
										(this.$AdStatsBehavior6 = 0);
								};
								d.onMostlyLeft = function() {
									(this.$AdStatsBehavior2 +=
										b("getTime")() - this.$AdStatsBehavior5),
										(this.$AdStatsBehavior5 = 0);
								};
								d.onCompletelyLeft = function() {
									(this.$AdStatsBehavior1 +=
										b("getTime")() - this.$AdStatsBehavior4),
										(this.$AdStatsBehavior4 = 0);
								};
						...
						function(a, b, c, d, e, f, g) {
							...
							a = (function() {
								...
								function a(a, c) {
									...
									this.$4 = a;
									this.$21 = new (b("ANEventCounter"))();
									this.$12 = !1;
									this.$13 = !1;
									this.$24 = !1;
									this.$3 = !1;
									this.$21.addListener(function() {
										return d.$26.mediaLoaded();
									});
									this.$9 = a.displayFormat || a.format || "300x250";
									this.tagJsIframeAppendedTime = a.tagJsIframeAppendedTime;
									this.$22 = new (b("ANLogger"))(
										b("LogLevels").ERROR,
										a.tagJsInitTime,
									...
									this.$10 = c;
									this.$11 = new (b("HTMLElementFrameContext.adquality"))(
										this.$10,
										this.$30()
									);
									this.$2 = null;
									this.$19 = new (b("OnScreenBehaviorManager.anweb"))();
									this.$23 = new (b("ANLinkOpener"))(this.$10);
								}
								var c = a.prototype;
								c.$29 = function() {
									return b("ANUtils").onlyString(this.$4.data.key);
								};
								...
								c.$30 = function() {
									return this.$10.ownerDocument.defaultView;
								};
								c.$31 = function() {
								...
								c.$33 = function() {
									return b("nullthrows")(this.$25);
								};
								c.$34 = function() {
									var a = this.$35() ? this.$7 || this.$10 : this.$10;
								...
								c.$41 = function(a, c) {
									...
									if (!this.$36()) {
										...
										f = new (b("ANAdChoices"))(e, a, this.$22);
										f.render();
										return;
									}
									f = null;
									this.$28
										? (f = this.$28.getXoutButton())
										: this.$40() && (f = this.$34());
									if (f == null) {
										f = document.createElement("a");
										f.href = "#";
									...
									var h = this.$40()
										...
										j = new (b("ANXOut"))({
											...
											onXOutStart: function() {
												h &&
													c &&
													(j.setOverlayBackgroundColor(h.getBackgroundColor()),
													h.resize(),
													c.resize(d.$14, h.getAdHeight())),
													d.$22.event(b("ANMWebXOutClientEvent").START, i);
											},
											onXOutCancel: function() {
												h &&
													...
													c.resize(d.$14, h.getAdHeight())),
													d.$22.event(b("ANMWebXOutClientEvent").CANCEL, i);
											},
											onXOutOption: function(a) {
												d.sendToFacebook({
													name: "xout",
													params: { key: d.$29(), reason: a, type: i }
												}),
													d.$22.event(
											...
											onXOutFinish: function() {
												d.$26.adClosed(),
													d.$22.event(b("ANMWebXOutClientEvent").FINISH);
											}
										});
									j.render();
									return;
								...
								c.renderAd = function(a, c, d, e) {
									...
									e = a.features || {};
									this.$25 = {
										$45: !!e.clickOpenNewTab,
										$46: !!e.enableWhiteops,
										$47: e.appIDHashed,
										$42: e,
										$37: e.inlineXOut,
										$48: !!e.useIntersectionObserver,
										$49: !!e.useCtaFallback,
										$44: a.xout,
										$50: e.clickGuardElements || i,
										$51: j(e.video || {}),
										$52: e.fullwidthMinAspectRatio || 1.5,
										$53: e.separateVideoViewability === !0,
										$54: e.pubSideLogging === !0,
										$55: e.moatUrl,
										$56: e.earlyAdLoaded === !0,
										$57: e.playWhenMostlyVisible === !0
									};
									this.$22.setLogLevel(
										this.$33().$42.logLevel || b("LogLevels").ERROR
									);
									this.$22.frameReady();
									this.$22.setUnifiedLoggingURL(a.unifiedLoggingURL);
									this.$1 = b("getTime")();
									e = this.$58();
									if (e === "SAFE_FRAME" || e === "NESTED_SAFE_FRAME") {
										e = this.$11.getSafeFrameAPI();
										if (e) {
											e = e.supports();
											e["exp-push"]
												? this.$22.event(
									...
									this.$33().$42.rp && this.$26.enableReward();
									var g = 0,
									...
									this.$33().$42.resizeMediaView
										? window.setTimeout(function() {
												...
												var d = new (b("ANFullWidthLoader"))(
													...
													e = f.$38();
												e.style.width = b("ANUtils").cssSize(f.$14);
												f.$5 && f.$5.ensureSizes();
												e = d.resize(f.$14, e.offsetHeight);
												e && ((f.$12 = !0), (f.$13 = !!a.nativeCarouselAds));
												f.$41(a.nativeAd, d);
												if (h) {
													var i = function() {
														(a.creativeMarkupBackup.use_carousel_stitch = !0),
															...
															f.$63(
																...
																c,
																!!f.$33().$42.resizeMediaView
															),
															(f.$12 = !1),
															(f.$13 = !1),
															f.$41(a.nativeAd),
															(f.$10.style.visibility = "visible");
													};
													if (!e) i();
													else {
														e = function a() {
										...
										: this.$41(a.nativeAd);
									this.$33().$49 === !0 &&
										(this.$18 = this.$64(a.nativeAd, this.$10, c));
									this.$65(!!a.nativeAd.adVideo);
									this.$22.eventWithParams(this.$66("ADNW_ADLOADED"));
									this.$67();
									this.$33().$56 || d(a.placementId);
									b("ANUtils").autofitTextWhereNeeded(this.$38());
								...
								c.$66 = function(a) {
									...
									c = this.$17.getLastViewabilityState();
									return {
										event_name: a,
								...
								c.$67 = function() {
									var a = this.$33().$42.forceIframeSize;
									if (a) {
										var c = this.$31();
										c &&
								...
								c.$61 = function() {
									...
									this.$14 = c - e * 2;
									this.$14 < a &&
										((this.$14 = a), (e = d.getBoundingClientRect().right - a));
									return e;
								};
								c.$59 = function() {
									__p && __p();
								...
								c.$69 = function(a) {
									return a && a.video ? j(a.video) : this.$33().$51;
								};
								c.$62 = function(a, b, c, d, e) {
									(a.nativeAd.loaded = !1),
										b && b.raw && ((this.$7.innerHTML = b.raw), (c = this.$7)),
										c && ((c = this.$38()), this.$32(c)),
										this.$33().$49 !== !0 &&
											(this.$18 = this.$64(a.nativeAd, c, d)),
										(this.$16 = this.$70(
											c,
											a.requestId,
											a.creativeMarkup,
								...
								c.$71 = function(a, c) {
									...
									b("ANUtils").resizeElement(
										c,
										this.$14,
										Math.round(this.$14 / a)
									);
								};
								c.$73 = function() {
									this.$22.eventWithParams(
										this.$66("ADNW_MOSTLY_VIEWABLE_FOR_1S")
									);
								};
								c.$74 = function() {
									__p && __p();
									if (this.$2) {
										this.$22.error("Multiple ADIMPRESSION attempted.");
										return;
									}
									this.$2 = b("getTime")();
									var a = this.$75();
									...
									this.$22.eventWithParams(this.$66("ADNW_ADIMPRESSION"));
									this.$36() &&
										this.$22.event(b("ANMWebXOutClientEvent").HAS_INLINE_XOUT);
									this.$76();
								};
								c.$76 = function() {
									__p && __p();
									...
									var d = this.$10;
									if (d == null) {
										this.$22.error("missing ad element");
										return;
									}
								...
								c.$58 = function() {
									var a = this.$11.getSafeFrameAPI();
									if (this.$11.isCrossDomain() && !a)
										return b("AMPContextLoader").isAMP()
											? "AMP"
											: "CROSS_DOMAIN_IFRAME";
									var c = this.$11.getNestLevel();
								...
								c.$64 = function(a, b, c) {
									__p && __p();
									if (this.$33().$49 !== !0) return a && b ? b : c;
									a = a && b;
									if (a) {
								...
								c.$65 = function(a) {
									__p && __p();
									var c = this;
									this.$17 = new (b("AdQualityViewabilityMonitor"))(
										this.$18,
										this.$33().$48
									);
									this.$17.attachBehaviorManager(this.$19);
									var d = new (b("AdImpressionBehavior.anweb"))(
										function() {
											(!a || !c.$77()) &&
												(c.$78(),
												a && c.$22.event("ADNW_VIDEO_IMPRESSION_ON_VISIBLE"));
										},
										function() {
											return c.$22.event("ADNW_PARTIAL_ADIMPRESSION");
										}
									);
									this.$79() &&
										((this.$20 = new (b("AdStatsBehavior.anweb"))()),
										this.$19.addBehavior(this.$20));
									this.$19.addBehavior(d);
									this.$21.addListener(function() {
										return d.mediaLoaded();
									});
									if (this.$33().$42.useMostlyViewableImp) {
										var e = new (b("AdMostlyViewableImpressionBehavior.anweb"))(
											function() {
												return c.$73();
											}
										);
										this.$19.addBehavior(e);
										this.$21.addListener(function() {
								...
								c.$80 = function(a, b, c, d, e, f) {
									this.$33().$42.useClientSideCarouselCollage &&
									e &&
									c &&
									!c.use_carousel_stitch
										...
										: e && c && !c.use_carousel_stitch
											...
											: d.adVideo
												? this.$83(b, d, f)
												: e && c && c.use_carousel_stitch && e.length > 1
													? this.$84(b, e)
													: this.$85(b, d);
								};
								c.$82 = function(a, c) {
									...
									var d = this,
										e = new (b("ANCarousel"))({
											...
											onLoadEventCounter: this.$21,
											adFeatures: this.$33().$42
										});
								...
								c.$81 = function(a, c) {
									var d = this,
										e = this.$33().$42.useExtendedCollage;
									e || (e = !1);
									e = new (b("ANCollage"))({
										ads: c,
										onLoadEventCounter: this.$21,
								...
								c.$84 = function(a, c) {
									var d = new (b("ANStitchedImage"))(this.$21, this.$22);
								...
								c.$83 = function(a, c, d) {
									...
									this.$21.addRequiredEvent();
									c = new (b("ANWebVideoPlayer.anweb"))(
										b("nullthrows")(c.adVideo),
										c.adImage,
										d,
										function() {
											e.$21.requiredEventFired();
										},
										this.$89
									);
									d = this.$39() && this.$26.isRewardEnabled();
									if (d) {
										var f = b("nullthrows")(this.$7);
										this.$28 = new (b("ANRewardedVideoPlayer"))(
											this.$26,
											f,
											c,
											this.$33().$37
										...
										f.style.maxWidth = "";
										this.$8 &&
											((this.$8.style.maxWidth = "100vw"),
											(this.$8.style.maxHeight = "100vh"));
									}
									...
									var g = new (b("ANWebVideoLogger.anweb"))(
										...
										function() {
											e.$77() &&
												(e.$78(), e.$22.event("ADNW_VIDEO_IMPRESSION_ON_PLAY"));
										}
									);
								...
								c.$90 = function(a) {
									this.$22.logClick(a, b("nullthrows")(this.$1));
									var c = a.href;
									a.clickParams.clknutab !== !0 || b("ANUtils").isAppStoreURL(c)
										? this.$23.open(c)
										: this.$23.openNewTab(c);
								};
								c.$86 = function(a, c) {
									__p && __p();
									var d = this,
										e = function(a, e) {
											...
											var i = {};
											if (d.$17) {
												var j = d.$17.getDimensions(),
													k = d.$17.getLastViewabilityState();
												j != null &&
													((i.height = j.height),
													(i.width = j.width),
													k.widthInView != null &&
											...
											j =
												d.$33().$54 &&
												d.$22.isPublisherSideLoggingSupported() &&
												a === b("ANUnifiedLoggingClickEvent").BILLABLE_CLICK;
											j &&
												g === "" &&
												(d.$22.error("pub_logging_no_href"), (j = !1));
											f = {
												key: d.$29(),
												href: b("nullthrows")(g),
												clickParams: k,
												adElementType: h,
												action: a,
												videoDuration: d.$27 == null ? 0 : d.$27.getDuration(),
												videoPlaybackTime:
													d.$27 == null ? 0 : d.$27.getCurrentTime(),
												pos: {
													element: h,
													width: i.width,
													height: i.height,
													...
													carouselCardIndex:
														d.$5 == null ? null : d.$5.getIndex()
												}
											};
											j
												? d.$90(f)
												: (d.sendToFacebook({ name: "click", params: f }),
												  d.$33().$45 &&
														g &&
														!e &&
														a ===
											...
											if (d.$33().$45 || e) {
												...
												k.onBounceBack(function(a) {
													d.sendToFacebook({
														...
														d.$22.event("ADNW_BOUNCEBACK", "" + a);
												});
											}
										},
										f = function() {
											b("ANWebTwoStepClickDialog")
												.openDialog(d.$38(), c.adSubtitle, c.adIcon)
								...
								c.$96 = function(a, c, d, e, f, g, h) {
									...
									for (i = 0; i < this.$15.length; i++)
										(j = !0),
											f && !e && this.$71(d, this.$15[i]),
											this.$80(a, this.$15[i], c, d, e, h);
									this.$93(a, d, g);
									c = a.getElementsByClassName(b("ANMWebAdElement").FB_AD_ICON);
									for (i = 0; i < c.length; i++) c[i].appendChild(this.$94(d));
									return j;
								};
								c.$93 = function(a, c, d) {
									__p && __p();
									...
									if (c.adCallToAction == null || c.href == null)
										...
										for (e = 0; e < d.length; e++) this.$86(d[e], c);
									}
								};
								c.$94 = function(a) {
									var b = this,
								...
								c.$97 = function() {
									return this.$9 === "native";
								};
								c.$39 = function() {
									return this.$9 === "rewarded_video";
								};
								c.$98 = function() {
									return this.$9 === "text";
								};
								c.$43 = function() {
									return this.$9 === "recirculation";
								};
								c.$40 = function() {
									return this.$98() || !!this.$33().$42.forceFullwidthTextOnly;
								};
								c.$35 = function() {
									return !this.$31() && !this.$97() && h[this.$9];
								};
								c.$78 = function() {
									this.$38().classList.add("fbVisibleOnce"), this.$74();
								};
								c.$75 = function() {
									var a = this.$17.getDimensions(),
										c =
											(this.$17 && this.$17.getLastViewabilityState()) || null;
									return {
										...
										hosturl: this.$11.getTopURL(),
										iframe_status: this.$58(),
										nest_level: this.$11.getNestLevel(),
										iframe_urls: this.$11.ancestorURLs.slice(0, -1),
								...
								c.$77 = function() {
									return this.$33().$42.videoMrcImpression === !0;
								};
								c.$79 = function() {
									return this.$33().$42.logPerformanceStats === !0;
								};
								c.$68 = function() {
									__p && __p();
									if (!this.$79()) return;
						...
						function(a, b, c, d, e, f) {
							...
							a = (function() {
								...
								c.adLoaded = function(a, c, d, e, f, g) {
									...
									var h = a.features || {};
									this.$3.setLogLevel(h.logLevel || b("LogLevels").ERROR);
									this.$3.frameReady();
									if (!a.success) {
										this.$3.error();
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"1000826497","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
