/*1540125461,,JIT Construction: v4445569,en_US*/
					...
					__d(
						...
						function(
							...
							function a(a) {
								...
								this.$28 = new s(a.onRewardCompleted);
								this.$4 = !1;
								this.$22 = !1;
								this.$5 = a;
								this.$23 = new o();
								...
								b =
									...
									0;
								this.$24 = new r(B.ERROR, a.tagJsInitTime, b, this.sendSignal);
							...
							a.prototype.$36 = function(a) {
								...
								var b = this.$35();
								if (this.$33()) {
									var c = !!this.$32().$37.inlineXOutCondensed,
										d;
									if (!c) {
										var e = new l(b, a);
										d = e.render();
									...
									e = new x({
										...
										onXOutStart: function() {
											this.$24.event(y.START, f);
										}.bind(this),
										onXOutCancel: function() {
											this.$24.event(y.CANCEL, f);
										}.bind(this),
								...
								c = new k(b, a, !!this.$32().$37.adChoicesBiggerClickArea);
								c.render();
							};
							a.prototype.adLoaded = function(a, b, c, d) {
								...
								this.$24.setLogLevel(this.$32().$37.logLevel || B.ERROR);
							...
							a.prototype.$49 = function() {
								var a = this.$32().$37.forceIframeSize;
								if (a) {
									var b = this.$30();
									b &&
							...
							a.prototype.loadVideo = function(a, b, c) {
								...
								var d = new w(
									I(b.adVideo),
									b.adImage,
									this.$32().$37.videoBlendedBackground,
									function() {
								...
								this.$28.attachVideo(d.getVideoElement());
							...
							a.prototype.installLink = function(a, b) {
								...
								var c = function(a) {
									...
									var d = H(),
										e = b.href,
										f = t.maybeHTMLElement(a.target);
									f = f ? this.$53(f) : "UNKNOWN";
									var g = {};
									if (this.$19) {
										...
										h != null &&
											...
											i.widthInView != null &&
												i.heightInView != null &&
												((g.visibleWidth = Math.round(i.widthInView * h.width)),
												(g.visibleHeight = Math.round(
													i.heightInView * h.height
												))));
										this.$12.getSafeFrameAPI()
											? ((g.relClickX = a.clientX), (g.relClickY = a.clientY))
											: ((g.clickX = a.clientX),
											  (g.clickY = a.clientY),
											  i.viewportLeft != null &&
													i.viewportTop != null &&
													((g.relClickX = a.clientX - i.viewportLeft),
													(g.relClickY = a.clientY - i.viewportTop)));
									}
									h = {
									...
									g.height &&
										...
										(h.vp =
											...
											(g.height * g.width));
									i = K.BILLABLE;
									g = this.$32().$37.minClickDelay;
									g &&
										this.$1 &&
										this.$1 + g > d &&
										!this.$3 &&
										((this.$3 = !0), (i = K.FAST_CLICK_GUARD));
									if (
										f !== "CTA" &&
										...
										i = K.TWO_STEP_OPEN_DIALOG;
										g = this.$5.data.nativeAd;
										u.openDialog(this.$35(), g.adSubtitle, g.adIcon)
											.onConfirm(
												function(event) {
													(this.$26 = !0), c(event);
												}.bind(this)
								...
								if (d && !!this.$32().$37.clickConfirmation) {
									var e = I(d.querySelector(".adnwCancelLink"));
									e.addEventListener("click", function(event) {
										d.style.display = "none";
									});
									e = I(d.querySelector(".adnwContinueLink"));
									e.addEventListener("click", function(event) {
							...
							a.prototype.$42 = function() {
								return !this.$30() && !this.$56() && J[this.$10];
							};
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"4445569","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
