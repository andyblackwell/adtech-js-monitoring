...
*/
	...
	var Yb = function(a, b, c) {
		...
		ec = function() {
			return p(Object.keys(Xb.f().a), function(a) {
				return Number(a);
			});
		},
		fc = function(a) {
	...
	var Pc = [12, 13],
		...
		Vc = function(a, b, c) {
			a.b[c] || (a.b[c] = []);
			a = a.b[c];
			q(a, b) ? Cb({ eids: JSON.stringify(a), dup: b }) : a.push(b);
		},
		Xc = function(a, b) {
			a.a.push.apply(
				a.a,
		...
		Uc = function(a, b) {
			...
			if (f)
				return (
					...
					(b = Yc(b, e)),
					!b || (c && !Kb(H(b, J, 3), c)) ? null : Zc(a, [b], 1)
				);
			d = c
				? va(d, function(g) {
						return Kb(H(g, J, 3), c);
		...
		if (!rd.o()) {
			var a = h.document,
				b = function(e) {
					...
					gb(f, e);
					try {
						(a.head || a.body || a.documentElement).appendChild(f), rd.B();
					} catch (g) {}
				},
				c = W[1];
			b(c);
	...
	var td = function(a) {
		...
		ud = function(a, b, c) {
			...
			md();
			1 == c ? a.M() : a.L();
			if (!d && a.P()) jd(".google.com") && (W[1] = ".google.com"), a.s();
			else {
	...
	var ce = function(a) {
		...
		de = function() {
			var a = [Ed, Dd, new v(u, "2020042701"), new v(u, ".js")];
		...
		ee = function(a, b, c) {
			...
			R.f().a(12);
			R.f().a(5);
			Q(200) || Q(220) || ((b = T(150)), md(), jd(b) && (W[1] = b));
			Q(312) &&
				(void 0 === Od &&
					(document.hasTrustToken ? (Od = new Pd(c)) : (Od = null)),
				(c = Od),
				c && Qd(c));
		},
		fe = function(a, b, c) {
		...
		[
			...
			[
				...
				[
					...
					[
						[21065928],
						[21065929, [[null, 45, null, [null, 0.5]], [291, null, null, [1]]]],
						[21065930, [[null, 45, null, [null, 0.1]], [291, null, null, [1]]]]
					]
				],
				[
					5,
				...
				[
					1,
					[
						[21065968, [[229, null, null, [1]]]],
						[
							21065969,
							[
								[null, 49, null, [null, 10]],
								[null, 50, null, [null, 1]],
								[229, null, null, [1]]
							]
						],
				...
				[1, [[21065979], [21065980, [[322, null, null, [1]]]]], null, 22],
				[
					1,
					[
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21065983]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21065983]]
							],
