/*1540367565,,JIT Construction: v4456582,en_US*/
				...
				with (this) {
					...
					__d(
						...
						function(
							...
							a.prototype.$56 = function(a, b, c, d, e, f) {
								b.loaded = !0;
								var g;
							...
							a.prototype.$44 = function() {
								return !this.$30() && !this.$58() && J[this.$10];
							};
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"4456582","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
