/*1537860019,,JIT Construction: v4348146,en_US*/
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h, i, j, k, l) {
							...
							a.prototype.$21 = function() {
								if (this.$11.option_type === this.$7.follow_up_report) {
									this.$12 = "report";
									this.$20();
									return;
								}
							...
							a.prototype.$22 = function() {
								var a = new h(
									...
									this.$6,
									function(a) {
										(this.$12 = a), this.onInitialStepDone();
									}.bind(this),
									function() {
										this.$9(), this.$15();
									}.bind(this)
							...
							a.prototype.render = function() {
								...
								if (this.$4 == null) {
									var a = document.createElement("a");
									a.href = "#";
									a.className = "_6qhg" + (this.$13 ? " _6r2w" : "");
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"4348146","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
