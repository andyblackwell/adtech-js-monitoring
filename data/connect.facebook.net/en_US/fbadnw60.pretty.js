/*1566252372,,JIT Construction: v1001075475,en_US*/
							...
							b = (function() {
								...
								b.onMoveEnd = function() {
									...
									var c = -this.$8,
										d = Math.round(
											this.$12
												? o * this.$11.getItemWidthRatio()
												: n * this.$11.getItemWidthRatio()
										);
									b === "right" ? (c += d) : (c -= d);
						...
						function(a, b, c, d, e, f, g, h) {
							...
							c = (function() {
								...
								c.$19 = function() {
									...
									this.$13 = new (b("ANCarouselMotion"))(
										this,
										function(b, c) {
											a.$20() && (a.$23(), a.$18 && a.$24()),
							...
							a = (function() {
								...
								c.$4 = function() {
									var a = this.$2 - 2 * h - 2 * g,
										c = a,
										d = this.$3.getElementsByClassName(
											"adnwMultiAdsContent"
										)[0],
							...
							a = (function() {
								...
								c.$7 = function() {
									var a = h("_82tm"),
										b = h("_82tn"),
										c = h("_82to"),
										d = h("_82tp" + (this.$6 ? " _8biy" : "") + " fbAdLink", [
											h("_82tq"),
					...
					__d(
						...
						function(a, b, c, d, e, f, g, h) {
							...
							function n(a) {
								...
								return a === "clickthrough_minimal"
									? new (b("ANWebClickThroughVideoPlayerControls"))(!0)
						...
						function(a, b, c, d, e, f, g) {
							...
							a = (function() {
								...
								c.renderAd = function(a, c, d, e) {
									...
									e = a.features || {};
									this.$26 = {
										$51: !!e.clickOpenNewTab,
										$52: !!e.enableWhiteops,
										$53: e.appIDHashed || "",
										$46: e,
										$41: e.inlineXOut,
										$54: !!e.useIntersectionObserver,
										$55: !!e.useCtaFallback,
										$48: a.xout,
										$56: e.clickGuardElements || i,
										$57: e.fullwidthMinAspectRatio || 1.5,
										$58: e.separateVideoViewability === !0,
									...
									this.$23.setLogLevel(
										this.$37().$46.logLevel || b("LogLevels").ERROR
									);
									this.$23.frameReady();
									...
									this.$37().$55 === !0 &&
										(this.$19 = this.$70(a.nativeAd, this.$11, c));
									this.$71(!!b("nullthrows")(a.nativeAd).adVideo);
									this.$23.eventWithParams(this.$72("ADNW_ADLOADED"));
									...
									this.$34().addEventListener("beforeunload", function() {
										f.$23.event("ADNW_PAGE_UNLOADED"), f.$73();
									});
								...
								c.$68 = function(a, b, c, d, e) {
									(a.nativeAd.loaded = !1),
										...
										this.$37().$55 !== !0 &&
											(this.$19 = this.$70(a.nativeAd, c, d)),
										(this.$17 = this.$75(
											c,
											a.requestId,
											a.creativeMarkup,
								...
								c.$78 = function() {
									this.$23.eventWithParams(
										this.$72("ADNW_MOSTLY_VIEWABLE_FOR_1S")
									);
								};
								c.$79 = function() {
									__p && __p();
									...
									this.$23.eventWithParams(this.$72("ADNW_ADIMPRESSION"));
									this.$40() &&
								...
								c.$70 = function(a, b, c) {
									__p && __p();
									if (this.$37().$55 !== !0) return a && b ? b : c;
									a = a && b;
									if (a) {
								...
								c.$77 = function(a) {
									if (a.adImageAspectRatio != null && a.adImageAspectRatio > 0)
										return Math.max(a.adImageAspectRatio, this.$37().$57);
									else if (a.adVideo) return 1.75;
									else return 1.9;
								};
								c.$85 = function(a, b, c, d, e, f) {
									this.$37().$46.useBannerV2 || this.$37().$46.isIab
										? (this.$86(b, d), (this.$31 = "image"))
								...
								c.$89 = function(a, c, d) {
									...
									d = this.$43() && this.$27.isRewardEnabled();
									if (d) {
									...
									var g = new (b("ANWebVideoLogger.anweb"))(
										...
										function() {
											e.$82() &&
												(e.$83(), e.$23.event("ADNW_VIDEO_IMPRESSION_ON_PLAY"));
										}
									);
								...
								c.$91 = function(a, c) {
									...
									var d = this,
										e = function(a, e) {
											...
											h = h ? d.$96(h) : b("ANMWebAdElement").UNKNOWN;
											var i = {};
											if (d.$18) {
										...
										g = function(a) {
											...
											g = g ? d.$96(g) : b("ANMWebAdElement").UNKNOWN;
								...
								c.$102 = function(a, b) {
									return this.$37().$46.showMultiAds ? !1 : a && !b;
								};
								...
								c.$98 = function(a, c, d) {
									...
									if (c.adCallToAction == null || c.href == null)
										...
										for (e = 0; e < d.length; e++) this.$91(d[e], c);
									}
								};
								c.$99 = function(a) {
									var c = this,
								...
								c.$44 = function() {
									return this.$104() || !!this.$37().$46.forceFullwidthTextOnly;
								};
								c.$39 = function() {
									return !this.$35() && !this.$103() && h[this.$10];
								};
								c.$83 = function() {
									this.$42().classList.add("fbVisibleOnce"), this.$79();
								};
								c.$80 = function() {
							...
							a = (function() {
								...
								c.adLoaded = function(a, c, d, e, f, g) {
									...
									if (a.errorCode === void 0) {
										...
										this.$3.error();
										e("1099", "Invalid ad data", a.placementId);
										return;
									}
								};
								return a;
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"1001075475","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
