...
*/
	...
	var ec = function(a, b, c) {
		...
		lc = function() {
			return t(Object.keys(dc.f().a), function(a) {
				return Number(a);
			});
		},
		mc = function(a) {
			u(dc.f().b, a) || ic(ac(4), a);
		};
	var M = function(a) {
			this.methodName = a;
		},
	...
	var md = function(a) {
			...
			d.hasOwnProperty("init-done")
				? (O(zc, d)(
						t(I(a, R, 2), function(f) {
							return f.h;
						})
				  ),
				  O(Ac, d)(
						t(I(a, K, 1), function(f) {
							return f.h;
						}),
						e
				  ),
