...
*/
	...
	var Xa = function(a) {
		...
		eb = function(a) {
			...
			p(a, e);
			return Ya(d.join(Xa(b).toString()), c);
		},
		bb = function(a) {
	...
	var wb = function(a, b) {
			if (!tb() && !ub()) {
				var c = Math.random();
				if (c < b) return (c = vb(h)), a[Math.floor(c * a.length)];
			}
			return null;
		},
		vb = function(a) {
	...
	var Pc = [12, 13],
		...
		Vc = function(a, b, c) {
			a.b[c] || (a.b[c] = []);
			a = a.b[c];
			r(a, b) ? Db({ eids: JSON.stringify(a), dup: b }) : a.push(b);
		},
		Xc = function(a, b) {
			a.a.push.apply(
				a.a,
		...
		if (!rd.o()) {
			var a = h.document,
				b = function(e) {
					...
					hb(f);
					try {
						(a.head || a.body || a.documentElement).appendChild(f), rd.C();
					} catch (g) {}
				},
				c = W[1];
			b(c);
	...
	var td = function(a) {
		...
		ud = function(a, b, c) {
			...
			md();
			1 == c ? a.O() : a.N();
			if (!d && a.S()) jd(".google.com") && (W[1] = ".google.com"), a.s();
			else {
	...
	var X = h.performance,
		...
		zd = t(function() {
			var a;
			if ((a = yd)) (a = Dc()), (a = !!a.indexOf && 0 <= a.indexOf("1337"));
			return a;
		});
	...
	Ad.prototype.i = function(a, b, c, d, e) {
		...
		(b.error && b.meta && b.id) || (b = new Bc(b, { context: a, id: e }));
	...
	var Dd = new v(u, "gpt/pubads_impl_"),
		Ed = new v(u, "https://securepubads.g.doubleclick.net/");
	var Fd = function(a) {
	...
	var dd = function() {
		...
		(a[17] = function(b) {
			...
			if ((e = (e = e.location.href.match(sb)[3] || null) ? decodeURI(e) : e)) {
				var f = e.length;
				if (0 == f) e = 0;
				else {
	...
	var ce = function(a) {
		...
		ee = function() {
			var a = [Ed, Dd, new v(u, "2020061102"), new v(u, ".js")];
		...
		fe = function(a, b) {
			Ud(172, a.currentScript || ce(a));
			new be(b);
			R.f().a(12);
			R.f().a(5);
			Q(200) || Q(220) || ((a = T(150)), md(), jd(a) && (W[1] = a));
			Q(312) &&
				Pd(
					new Od(function(c) {
						Ud(250, c);
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066384]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066384]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066386]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066386]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066387]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066387]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066388]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066388]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066389]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066389]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21066403]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21066403]]
							],
