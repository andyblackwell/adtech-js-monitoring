...
*/
		...
		Nb = function(a) {
			...
			a: {
				for (c = 0; 0 <= (c = a.indexOf("network-code", c)) && c < b; ) {
					...
					if (38 == d || 63 == d)
						if (
							((d = a.charCodeAt(c + 12)), !d || 61 == d || 38 == d || 35 == d)
						)
							break a;
					c += 13;
				}
	...
	var Rb = function(a, b) {
		...
		Ub = /^(-?[0-9.]{1,30})$/,
		Vb = function(a, b) {
			return Ub.test(a) && ((a = Number(a)), !isNaN(a))
				? a
				: void 0 == b
					? null
					: b;
	...
	var rd = [12, 13],
		...
		ud = function(a, b, c) {
			if (a.l[b])
				return (
					0.001 >= Math.random() && Zb({ b: c, dp: b }, "tagging_dupdiv"), !0
				);
			a.l[b] = !0;
			return !1;
		},
		...
		xd = function(a, b, c) {
			...
			a = a.a[c];
			Ia(a, b)
				? Zb({ eids: JSON.stringify(a), dup: b }, "gpt_dupeid")
				: a.push(b);
		},
		zd = function(a, b) {
			a.f.push.apply(
	...
	var ce = function() {
			...
			if (U(203) && !window.google_plmetrics && window.PerformanceObserver) {
				...
				for (
					...
					(c = c.value), ae(a).observe({ type: c, buffered: !U(240) });
				be(a);
			}
		},
		ae = function(a) {
										...
										try {
											if (
												...
												for (
													...
													Xd.add(h.value.getSlotId().getDomId());
											}
										} catch (p) {}
										c = !0;
									}
	...
	var le = [
		...
		me = function(a) {
			return a.navigator &&
				...
				? a.navigator.userAgentData.getHighEntropyValues(le).then(function(b) {
						var c = new dc();
						c = J(c, 1, b.platform);
	...
	[
		...
		[
			...
			[
				...
				[1, [[21068466], [21068467, [[456, null, null, [1]]]]]],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21068503]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21068503]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21068504]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21068504]]
							],
