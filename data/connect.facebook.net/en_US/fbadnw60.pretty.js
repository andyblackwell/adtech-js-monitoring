/*1583278654,,JIT Construction: v1001785816,en_US*/
										...
										var a =
											this.$6 === ""
												...
												: i("_8fla _11u_", [
														...
														m("_8fle _11vj", this.$6)
												  ]);
										return l("_8flf _11u9", [
											i("_11ur", [i("_11us"), i("_8flg _11u-", [a])])
										]);
									}
						...
						function(a, b, c, d, e, f, g, h) {
							...
							a = (function() {
								...
								c.getMaxOffset = function() {
									return this.$18
										? this.getFullWidth() - this.$10 + q * 2
										: this.getFullWidth() - this.$10;
								};
								c.getIndex = function() {
									return this.$8;
								};
					...
					__d(
						...
						function(a, b, c, d, e, f, g) {
							...
							var h = b("VPAIDDomUtils").div,
								...
								j = function(a, b) {
									b === void 0 && (b = "");
									return i("div", { className: a, textContent: b });
								};
							a = (function() {
								function a(a, b) {
									this.$1 = h("_8fl8", [
										h("_8fl9", [j("_8fkt", b), j("_8fku", a)])
									]);
								}
								var b = a.prototype;
						...
						function(a, b, c, d, e, f) {
							...
							a = (function() {
								...
								c.resize = function(a, c, d) {
									this.$4 === !0
										? this.addChanges(a, { width: b("ANUtils").cssSize(c) })
										: this.addChanges(a, {
						...
						function(a, b, c, d, e, f) {
							...
							a = (function() {
									...
									if (this.$7) {
										...
										e != null
											...
											: (this.$1.addChanges(d, {
											  ...
											  this.$9 ||
													this.$1.addChanges(d, { position: "initial" }));
									}
									this.$1.applyChanges();
								...
								c.$10 = function(a, c, d, e) {
									...
									this.$1.resize(c, d, e);
									this.$1.addChanges(c, { "margin-left": "0" });
									this.$9 ||
										(this.$1.addChanges(a, { position: "initial" }),
										this.$1.addChanges(c, { position: "initial" }));
								};
								c.restoreOriginalStyles = function() {
							...
							a = (function() {
								...
								c.$45 = function(a, c) {
									...
									if (!this.$40()) {
										if (this.$37().$46.anXOutIcon) {
											...
											this.$37().$46.padXoutArea === !0
												? (f.className = b("joinClasses")(
														"_6qhg",
														"_7-er",
														"_8bwk"
												  ))
									...
									if (f == null) {
										...
										this.$37().$46.anXOutIcon
											...
											: this.$47()
												? (g.push("_7-e_"),
												  this.$37().$46.padXoutArea === !0 && g.push("_8bwv"))
												: this.$37().$46.padXoutArea === !0 && g.push("_8bwk");
										...
										var j = new (b("ANXOut"))({
											...
											onXOutCancel: function() {
												h &&
													...
													c.resize(d.$15, h.getAdHeight())),
													d.$23.event("ADNW_XOUT_CANCEL", i);
											},
											onXOutOption: function(a) {
												d.sendToFacebook({
													name: "xout",
													params: { key: d.$33(), reason: a, type: i }
												}),
								...
								c.$51 = function() {
									var a = !!this.$37().$46.isIab,
										b = !!this.$37().$46.useCardDesign;
									if (b) return this.$42().offsetHeight + l;
								...
								c.renderAd = function(a, c, d) {
									...
									var e = this,
										f = a.features || {};
									this.$26 = {
										$52: !!f.clickOpenNewTab,
										$53: f.appIDHashed || "",
										$46: f,
										$41: f.inlineXOut,
										$54: !!f.useIntersectionObserver,
										$48: a.xout,
										$55: f.clickGuardElements || i,
										$56: f.fullwidthMinAspectRatio || 1.5,
										$57: f.pubSideLogging === !0,
										$58: f.moatUrl,
										$59: f.earlyAdLoaded === !0,
										$60: f.playWhenMostlyVisible === !0,
										$61: a.topDomain
									};
									...
									if (
										...
										window.setTimeout(function() {
											...
											var c = new (b("ANFullWidthLoader"))(
												...
												d = e.$42();
											d.style.width = b("ANUtils").cssSize(e.$15);
											e.$6 && e.$6.ensureSizes();
											d = e.$51();
											d = c.resize(e.$15, d);
											d && ((e.$13 = !0), (e.$14 = !!a.nativeCarouselAds));
											e.$45(b("nullthrows")(a.nativeAd), c);
											if (h) {
												var f = function() {
													(b("nullthrows")(
														...
														e.$68(a, b("nullthrows")(a.creativeMarkupBackup)),
														(e.$13 = !1),
														(e.$14 = !1),
														e.$45(b("nullthrows")(a.nativeAd)),
														(e.$11.style.visibility = "visible");
												};
												if (!d) f();
												else {
													d = function a() {
									...
									this.$19 = this.$69(a.nativeAd, this.$11, c);
									this.$70(!!b("nullthrows")(a.nativeAd).adVideo);
									this.$23.eventWithParams(this.$71("ADNW_ADLOADED"));
									f = new (b("ANPageNavigationManager"))(window.document);
									f.onNavigation(function() {
										e.$72();
									});
									this.$73();
									this.$37().$59 || d(a.placementId);
									this.$34().addEventListener("beforeunload", function() {
										e.$23.event("ADNW_PAGE_UNLOADED"), e.$72();
									});
									if (this.$74()) {
										c = new (b("ANBanner"))(this.$42(), this.$37().$46);
										c.init();
									}
									b("ANUtils").autofitTextWhereNeeded(this.$42(), function() {
										e.$23.event("ADNW_TEXT_AUTOFIT_ERROR");
									});
								};
								c.$71 = function(a) {
									var c = this.$18;
								...
								c.$66 = function(a, b, c, d, e) {
									(a.nativeAd.loaded = !1),
										b.raw && ((this.$8.innerHTML = b.raw), (c = this.$8)),
										c && ((c = this.$42()), this.$36(c)),
										(this.$17 = this.$75(
											c,
											a.requestId,
											a.creativeMarkup,
								...
								c.$77 = function(a, c, d, e) {
									...
									this.$37().$46.useCardDesign
										? b("ANUtils").resizeElement(
												e,
												this.$15 - k,
												Math.round((this.$15 - k) / f)
										  )
										: b("ANUtils").resizeElement(
												e,
												this.$15,
												Math.round(this.$15 / f)
										  );
								};
								c.$79 = function() {
									this.$23.eventWithParams(
										this.$71("ADNW_MOSTLY_VIEWABLE_FOR_1S")
									);
								};
								c.$80 = function() {
									__p && __p();
									...
									this.sendToFacebook({
										name: "impress",
										params: { key: this.$33(), payload: a }
									});
									this.$23.eventWithParams(this.$71("ADNW_ADIMPRESSION"));
								...
								c.$78 = function(a) {
									if (a.adImageAspectRatio != null && a.adImageAspectRatio > 0)
										return Math.max(a.adImageAspectRatio, this.$37().$56);
									else if (a.adVideo) return 1.75;
									else return 1.9;
								};
								c.$86 = function(a, c, d, e, f) {
									this.$37().$46.isIab || this.$37().$46.useBannerV3
										? (this.$87(a, d), (this.$31 = "image"))
										: this.$76(e) && c
											? (this.$88(a, b("nullthrows")(e)),
											  (this.$31 = "dpa"),
											  (this.$32 = b("nullthrows")(e).length))
											: (this.$37().$46.useLargeCarousel ||
													this.$37().$46.useLargeCarouselWithCounter) &&
											  e &&
											  c &&
											  !c.use_carousel_stitch
												? (this.$89(a, e),
												  (this.$31 = "carousel"),
												  (this.$32 = e.length))
												: this.$37().$46.useClientSideCarouselCollage &&
												  e &&
												  c &&
												  !c.use_carousel_stitch
													? (this.$90(a, e),
													...
													: e && c && !c.use_carousel_stitch
														? (this.$89(a, e),
														  ...
														  (this.$32 = e.length))
														: d.adVideo
															? (this.$91(a, d, f), (this.$31 = "video"))
															: e && c && c.use_carousel_stitch && e.length > 1
																? (this.$92(a, e),
																  (this.$31 = "stitched_carousel"))
																: (this.$87(a, d), (this.$31 = "image"));
								};
								c.$93 = function(a, c) {
									var d = "",
								...
								c.$91 = function(a, c, d) {
									...
									var g = new (b("ANWebVideoLogger.anweb"))(
										...
										function() {
											e.$83() &&
												(e.$84(), e.$23.event("ADNW_VIDEO_IMPRESSION_ON_PLAY"));
										}
									);
								...
								c.$68 = function(a, c) {
									...
									d.innerHTML = c.raw || "";
									this.$36(this.$42());
									this.$100(d, c, a.nativeAd, a.nativeCarouselAds, m(c.video));
									d &&
										((this.$18 = new (b("AdQualityViewabilityMonitor"))(
											d,
											this.$37().$54
								...
								c.$101 = function(a, b) {
									...
									if (b.adCallToAction == null || b.href == null)
										...
										for (c = 0; c < d.length; c++) this.$94(d[c], b);
									}
								};
								c.$102 = function(a) {
									var c = this,
								...
								c.$39 = function() {
									return !this.$35() && !this.$105() && h[this.$10];
								};
								c.$84 = function() {
									this.$42().classList.add("fbVisibleOnce"), this.$80();
								};
								c.$81 = function() {
								...
								c.$8 = function(a, c, d, e, f, h) {
									...
									p = b("ANRecirculationUnit").render(
										...
										function() {
											return e(
												a.errorCode || "1098",
												a.errorMsg || "Error rendering recirc",
												a.placementId
											);
										},
										function() {
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"1001785816","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
