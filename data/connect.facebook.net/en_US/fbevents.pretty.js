			...
			return (function(g, h, i, j) {
				...
				(function() {
					...
					var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"),
						...
						e = f.getFbeventsModules("SignalsFBEventsIWLBootStrapEvent"),
						g = f.getFbeventsModules("SignalsFBEventsPIIAutomatchedEvent"),
						h = f.getFbeventsModules("SignalsFBEventsPIIConflictingEvent"),
						i = f.getFbeventsModules("SignalsFBEventsPIIInvalidatedEvent"),
						j = f.getFbeventsModules("SignalsFBEventsPluginLoadedEvent"),
						l = f.getFbeventsModules("SignalsFBEventsSetIWLExtractorsEvent");
					a = {
						execEnd: new a(),
						fired: b,
						getCustomParameters: c,
						getIWLParameters: d,
						iwlBootstrap: e,
						piiAutomatched: g,
						piiConflicting: h,
					...
					j = (function() {
						...
						i(e, [
							...
							},
							{
								key: "configLoaded",
								value: function(a) {
									(this.configsLoaded[a] = !0), this.locks.releaseConfig(a);
								}
							}
						]);
						return e;
					...
					c = function c() {
						...
						this._sendXHRPost = function(b, c, d) {
							...
							if ("withCredentials" in e)
								...
								(e = new XDomainRequest()), e.open("POST", c), (e.onerror = g);
							else return !1;
							e.send(b.toFormData());
							return !0;
						};
				...
				(function() {
					...
					function r(a) {
						...
						if (i != null) {
							...
							j &&
								p === 0 &&
								i.isInExperimentGroup &&
								(e.logStartBatch(), setTimeout(q, 0));
						...
						if (
							(j || (!n && h === "SubscribedButtonClick")) &&
							c.sendBeacon.apply(c, i)
						) {
			...
			return (function(g, h, i, l) {
				...
				(function() {
					...
					var E = y.fired,
						...
						P;
					h.referrer;
					var Q = { PageView: new A(), PixelInitialized: new A() },
						R = new p(a, O),
						S = new w(R, H);
					function fa(a) {
					...
					function V(a, b, c) {
						...
						if (J.call(O, a)) {
							b && B(O[a].userData)
								? ((O[a].userData = b), S.loadPlugin("identity"))
								: G({ pixelID: a, type: "DUPLICATE_PIXEL_ID" });
							return;
						}
						c = {
