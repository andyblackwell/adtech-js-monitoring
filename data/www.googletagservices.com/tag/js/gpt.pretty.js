(function(E) {
	...
	var Ua = function(a) {
			return a instanceof z && a.constructor === z && a.g === Ta
				? a.c
				: "type_error:SafeUrl";
		},
	...
	var Za = function(a) {
			return a instanceof B && a.constructor === B && a.i === Ya
				? a.c
				: "type_error:SafeHtml";
		},
		$a = function(a) {
		...
		fb = function(a) {
			...
			p(a, e);
			return C(d.join(Za(b).toString()), c);
		},
		cb = function(a) {
	...
	var zb = function(a, b) {
			if (!wb() && !xb()) {
				var c = Math.random();
				if (c < b) return (c = yb(h)), a[Math.floor(c * a.length)];
			}
			return null;
		},
		yb = function(a) {
		...
		Cb = /^(-?[0-9.]{1,30})$/,
		Db = function(a, b) {
			return Cb.test(a) && ((a = Number(a)), !isNaN(a))
				? a
				: void 0 == b
					? null
					: b;
	...
	var Zb = function(a, b) {
		...
		cc = function(a) {
			var b = M.f().a;
			if (b) {
				var c = wa(J(a, Xb, 5), function(d) {
					return Rb(I(d, K, 1), b);
				});
				if (c) return I(c, Ub, 2);
			}
			return I(a, Ub, 4);
		},
		ec = function() {
	...
	var Pc = [12, 13],
		...
		Uc = function(a, b) {
			...
			if (f) {
				...
				b = Yc(b, e);
				return !b || (c && !Rb(I(b, K, 3), c)) ? null : Zc(a, [b], 1);
			}
			d = c
				? ua(d, function(g) {
						return Rb(I(g, K, 3), c);
		...
		if (!sd.o()) {
			var a = h.document,
				b = function(e) {
					...
					hb(f, e);
					try {
						(a.head || a.body || a.documentElement).appendChild(f), sd.A();
					} catch (g) {}
				},
				c = W[1];
			b(c);
	...
	var ud = function(a) {
		...
		vd = function(a, b, c) {
			...
			nd();
			1 == c ? a.K() : a.J();
			if (!d && a.N()) kd(".google.com") && (W[1] = ".google.com"), a.s();
			else {
	...
	var X = h.performance,
		...
		Ad = u(function() {
			var a;
			if ((a = zd)) (a = Kb()), (a = !!a.indexOf && 0 <= a.indexOf("1337"));
			return a;
		});
	...
	Bd.prototype.i = function(a, b, c, d, e) {
		...
		(b.error && b.meta && b.id) || (b = new Ib(b, { context: a, id: e }));
	...
	var Ed = w("gpt/pubads_impl_"),
		Fd = w("https://securepubads.g.doubleclick.net/");
	var Gd = function(a) {
	...
	var Y = function() {
			...
			this.R = !1;
			this.w = Jd(641, this.w.bind(this));
		},
		Ld = function() {};
	Y.prototype = da(Ld.prototype);
		...
		for (var Nd in Ld)
			if ("prototype" != Nd)
				if (Object.defineProperties) {
					var Od = Object.getOwnPropertyDescriptor(Ld, Nd);
					Od && Object.defineProperty(Y, Nd, Od);
				} else Y[Nd] = Ld[Nd];
	var Pd = function() {
		var a = new Y();
		a.O.observe({
	...
	var $d = function() {
		...
		(a[17] = function(b) {
			...
			if ((e = (e = e.location.href.match(vb)[3] || null) ? decodeURI(e) : e)) {
				var f = e.length;
				if (0 == f) e = 0;
				else {
	...
	var de = function() {
		var a =
			void 0 === a
				? Fa([
						w("https://ff.doubleclick.net/tag/js/fetch_frame_"),
						w("2019110401"),
						w(".html")
				  ])
				: a;
		...
		var c = function() {
			...
			b.removeEventListener && b.removeEventListener("load", c, !1);
		};
	...
	var ee = function(a) {
		...
		fe = function() {
			...
			a = Fa([Fd, Ed, a, w("2019110401"), w(".js")]);
			var b = void 0 === b ? 0 : b;
			if ((b = bd.f().c(24, b))) {
				b = String(b);
				a = Ea.exec(y(a).toString());
				var c = a[3] || "";
				a = new x(Ca, a[1] + Ga("?", a[2] || "", b) + Ga("#", c, void 0));
			}
			return a;
		},
		ge = function(a, b) {
			...
			Q.f().a(12);
			Q.f().a(5);
			S(200) || S(220) || ((b = T(150)), nd(), kd(b) && (W[1] = b));
		},
		he = function(a, b, c) {
			var d = Qd();
			a = a || d.fifWin || window;
