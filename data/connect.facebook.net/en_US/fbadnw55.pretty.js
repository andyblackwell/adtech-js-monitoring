/*1535941278,,JIT Construction: v4273925,en_US*/
	...
	new Image().src =
		...
		encodeURIComponent(
			'{"error":"LOAD", "extra": {"name":"' +
				...
				'","revision":"4273925","namespace":"FB","message":"' +
				e.message +
				'"}}'
		);
}
