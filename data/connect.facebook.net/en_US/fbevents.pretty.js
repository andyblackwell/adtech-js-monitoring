						...
						i(d, [
								...
								value: function(a) {
									a == "revoke"
										...
										: a == "grant"
											...
											: u({ type: "INVALID_CONSENT_ACTION", action: a });
									return this;
								}
							},
							{
							...
							},
							{
								...
								value: function(a) {
									...
									o.sendEvent(a.pixelId, a.eventName, a.customData, c);
									return this;
								}
							},
							{
								...
								value: function(a) {
									...
									else u({ type: "INVALID_FBQ_METHOD", method: b });
								}
							},
							{
							...
							},
							{
								key: "setExperiments",
								value: function(a) {
									this._defaultExperiments = new m(a);
								}
							},
							{
								key: "getExperiments",
