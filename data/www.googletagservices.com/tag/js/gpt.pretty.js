...
*/
			...
			var d = function(h, k) {
					...
					if (p && t(h.b, l))
						for (h = 0; h < p.length; h++) {
							var ha = p[h];
							if ((k !== k && ha.key !== ha.key) || k === ha.key)
								return { id: l, list: p, index: h, i: ha };
						}
	...
	var Tb = function(a, b) {
			var c = Qb();
			return !c && !Rb() && ((c = Math.random()), c < b)
				? ((c = Sb(u)), a[Math.floor(c * a.length)])
				: null;
		},
		Sb = function(a) {
		...
		Wb = /^(-?[0-9.]{1,30})$/,
		Xb = function(a, b) {
			return Wb.test(a) && ((a = Number(a)), !isNaN(a))
				? a
				: void 0 == b
					? null
					: b;
		...
		$b = function() {
			...
			if ((a = Pb(a.location.href.match(Ob)[3] || null))) {
				var b = a.length;
				if (0 == b) a = 0;
				else {
	...
	var Fc = Ec,
		...
		Kc = function(a) {
			var b = N.f().a;
			if (b) {
				var c = Ia(K(a, Dc, 5), function(d) {
					return yc(Ib(d, tc, 1), b);
				});
				if (c) return Ib(c, Ac, 2);
			}
			return Ib(a, Ac, 4);
		},
		Mc = function() {
	...
	var zd = [12, 13],
		...
		Fd = function(a, b, c) {
			a.b[c] || (a.b[c] = []);
			a = a.b[c];
			Ja(a, b) ? cc({ eids: JSON.stringify(a), dup: b }) : a.push(b);
		},
		Hd = function(a, b) {
			a.a.push.apply(
				a.a,
		...
		Ed = function(a, b, c) {
			...
			if (g) {
				...
				null === f && (f = Math.floor(1e3 * Sb(window)));
				b = Id(b, f);
				return !b || (d && !yc(Ib(b, tc, 3), d)) ? null : Jd(a, [b], 1);
			}
			g = d
				? Fa(e, function(k) {
						return yc(Ib(k, tc, 3), d);
				  })
				: e;
			return g.length
				? (b = I(b, 4, 0))
		...
		if (!ee.u()) {
			var a = u.document,
				b = function(e) {
					...
					zb(f, e);
					try {
						(a.head || a.body || a.documentElement).appendChild(f), ee.H();
					} catch (g) {}
				},
				c = W[1];
			b(c);
	...
	var ge = function(a) {
		...
		he = function(a, b, c) {
			...
			$d();
			1 == c ? a.U() : a.T();
			if (!d && a.W()) Xd(".google.com") && (W[1] = ".google.com"), a.v();
			else {
	...
	var X = u.performance,
		...
		me = Ka(function() {
			var a;
			if ((a = le)) (a = qc()), (a = !!a.indexOf && 0 <= a.indexOf("1337"));
			return a;
		});
	...
	var ye = function() {
		L.call(this);
		this.Y = this.K = this.L = this.c = this.F = this.D = this.j = 0;
		this.J = !1;
		this.G = this.A = this.g = 0;
		var a = document.querySelector("[data-google-query-id]");
		this.N = a ? a.getAttribute("data-google-query-id") : null;
		this.I = null;
		this.M = !1;
		this.X = function() {};
	};
							...
							switch (((d = d.value), d.entryType)) {
								case "layout-shift":
									...
									if (!d.hadRecentInput && (!S(241) || 0.01 < d.value)) {
										h.j += Number(d.value);
										Number(d.value) > h.D && (h.D = Number(d.value));
										h.F += 1;
										a: {
											if (d.sources) {
												var k = r(d.sources);
								...
								case "largest-contentful-paint":
									a.K = Math.floor(d.renderTime || d.loadTime);
									break;
								case "first-input":
									a.Y = Number((d.processingStart - d.startTime).toFixed(3));
									a.J = !0;
									break;
								case "longtask":
									(a.g += d.duration),
										d.duration > a.A && (a.A = d.duration),
										(a.G += 1);
							}
					})
				));
		...
		if (!a.M) {
			...
			window.LayoutShift &&
				...
				window.LayoutShiftAttribution &&
					((b += "&cas=" + a.c.toFixed(3)), (b += Y("nas", a.L))));
			window.LargestContentfulPaint && (b += Y("lcp", a.K));
			window.PerformanceEventTiming && a.J && (b += Y("fid", a.Y));
			window.PerformanceLongTaskTiming &&
				((b += Y("cbt", a.g)), (b += Y("mbt", a.A)), (b += Y("nlt", a.G)));
			for (
			...
			b += "&top=" + (u === u.top ? 1 : 0);
			if (a.N) c = "&qqid=" + encodeURIComponent(a.N);
			else {
				...
				a.j.forEach(function(b) {
					window
						...
						.then(function(c) {
							...
							Ge(a, b.issuerOrigin, 6);
						})
						.catch(function(c) {
							c && "NoModificationAllowedError" === c.name
								? Ge(a, b.issuerOrigin, 6)
								: Ge(a, b.issuerOrigin, 5);
						});
					Ge(a, b.issuerOrigin, 2);
				});
		};
	var Ie = [
			"platform",
		...
		Je = function(a) {
			return a.navigator &&
				...
				? a.navigator.userAgentData.getHighEntropyValues(Ie).then(function(b) {
						var c = new jc();
						c = J(c, 1, b.platform);
	...
	var Rd = function() {
		...
		(a[17] = function(b) {
			...
			return n(c, "includes").call(c, String($b()));
		}),
		(a[21] = function() {
			return T(148);
		}),
		...
		this[5] = ((a[5] = function() {
			var b = T(172);
			return b ? Pb(b.src.match(Ob)[3] || null) : void 0;
		}),
		a);
	};
	v(Rd);
	var Ve = [],
		We = function(a) {
			var b = new xd(T(246));
			a = new xd(a || Ve);
			if (!K(b, M, 1).length && K(a, M, 1).length) {
				var c = K(a, M, 1);
				Jb(b, 1, c);
			}
			!K(b, R, 2).length &&
	...
	var Xe = function(a) {
		...
		Ze = function() {
			...
			var b = "";
			for (var c = 0; c < a.length; c++) b += Oa(a[c]);
			b = new A(b, Qa);
			(a = Od(24))
				? ((a = String(a)),
				  (b = Va.exec(Ra(b).toString())),
				  (c = b[3] || ""),
				  (a = new A(b[1] + Wa("?", b[2] || "", a) + Wa("#", c, void 0), Qa)))
				: (a = b);
			return a;
		},
		$e = function(a, b, c) {
			a = a.currentScript || Xe(a);
			Ne.f()[172] = a;
			new We(b);
			nd.f().a(12);
			nd.f().a(5);
	...
	[
		...
		[
			...
			[
				...
				[10, [[21067332], [21067333, [[424, null, null, [1]]]]]],
				[
					1,
					[
						[21067362],
				...
				[10, [[21067374], [21067375, [[426, null, null, [1]]]]]],
				[
					1000,
					[
						[
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067401]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067401]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067402]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067402]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067406]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067406]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067407]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067407]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067416]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067416]]
							],
						...
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21067417]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21067417]]
							],
		...
		[
			...
			[
				...
				[null, [[44725623], [44725624, [[1901, null, null, [1]]]]], null, 28]
			]
		]
	]
]));
