...
*/
	...
	var Tc = [12, 13],
		...
		Yc = function(a, b) {
			...
			if (f) {
				...
				b = bd(b, e);
				return !b || (c && !Nb(I(b, K, 3), c)) ? null : cd(a, [b], 1);
			}
			d = c
				? va(d, function(g) {
						return Nb(I(g, K, 3), c);
	...
	var xd = function(a) {
		...
		yd = function(a, b, c) {
			...
			qd();
			1 == c ? a.L() : a.K();
			if (!d && a.O()) nd(".google.com") && (W[1] = ".google.com"), a.s();
			else {
	...
	var Hd = v("gpt/pubads_impl_"),
		Id = v("https://securepubads.g.doubleclick.net/"),
		Jd = v("https://ff.doubleclick.net");
	var Kd = function(a) {
	...
	Rd.prototype.a = function() {
		...
		if (
			...
			window.LayoutShift &&
				...
				(a += Y("nls", this.l)));
			window.LargestContentfulPaint && (a += Y("lcp", this.P));
			window.PerformanceEventTiming && this.H && (a += Y("fid", this.G));
			...
			p(a.c, function(b) {
				a.b
					.fetch(b + "/.well-known/trust-token", {
						...
						method: "get",
						mode: "no-cors",
						X: { type: "srr-token-redemption", V: b, W: "none" }
					})
					.then(function(c) {
	...
	var ie = function(a, b) {
		...
		je = function() {
			var a =
				void 0 === a
					? Ia([Jd, v("/tag/js/fetch_frame_"), v("2020031603"), v(".html")])
					: a;
			var b = sb();
	...
	var ke = function(a) {
		...
		le = function() {
			var a = Ia([Id, Hd, v("2020031603"), v(".js")]),
				b = Ec();
		...
		me = function(a, b, c) {
			...
			R.f().a(12);
			R.f().a(5);
			Q(200) || Q(220) || ((b = T(150)), qd(), nd(b) && (W[1] = b));
			Q(312) &&
				(void 0 === Ud &&
					(document.hasTrustToken ? (Ud = new Vd(c)) : (Ud = null)),
				(c = Ud),
				c && Wd(c));
		},
		ne = function(a, b, c) {
		...
		[
			...
			[
				...
				[
					...
					[
						[21065707],
						[21065708, [[244, null, null, [1]], [245, null, null, [1]]]],
						[21065709, [[244, null, null, [1]], [307, null, null, [1]]]],
						[21065710, [[244, null, null, [1]], [306, null, null, [1]]]]
					],
					null,
					19
				],
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21065717]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21065717]]
							],
				...
				[
					...
					[
						[
							...
							[
								[null, 7, null, [null, 1]],
								[null, 24, null, [null, 21065719]],
								[60, null, null, [1]],
								[null, 28, null, [null, 0.1]],
								[null, 25, null, [null, 21065719]]
							],
