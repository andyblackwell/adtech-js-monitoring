(function() {
	...
	var la = function(a, b) {
		...
		na = function(a, b) {
			for (
				var c = a.length, e = [], d = 0, f = p(a) ? a.split("") : a, h = 0;
				h < c;
				h++
			)
				if (h in f) {
					var n = f[h];
					b.call(void 0, n, h, a) && (e[d++] = n);
				}
			return e;
		},
		oa = function(a, b) {
	...
	var ya = function(a) {
			return a instanceof B && a.constructor === B && a.f === xa
				? a.b
	...
	var Ia = function(a, b) {
			if (!Fa() && !Ga()) {
				var c = Math.random();
				if (c < b) return (c = Ha()), a[Math.floor(c * a.length)];
			}
			return null;
		},
		Ha = function() {
	...
	F[36] = /^true$/.test("false");
	F[46] = /^true$/.test("false");
	F[148] = /^true$/.test("false");
	F[221] = /^true$/.test("");
	F[204] = La("{{MOD}}", -1);
	var G = function() {
	...
	var I = function() {},
				...
				for (b = 0; b < c.length; b++)
					(d = c[b]),
						d < a.h
							? ((d += a.f), (a.a[d] = a.a[d] || J))
							: (Va(a), (a.c[d] = a.c[d] || J));
			if (e && e.length) for (b = 0; b < e.length; b++) Wa(a, e[b]);
		},
		J = [],
		Va = function(a) {
			var b = a.h + a.f;
		...
		Wa = function(a, b) {
			for (var c, e, d = 0; d < b.length; d++) {
				var f = b[d],
					h = Xa(a, f);
				null != h && ((c = f), (e = h), Za(a, f, void 0));
			}
			return c ? (Za(a, c, e), c) : 0;
		},
		M = function(a, b, c) {
			a.b || (a.b = {});
			if (!a.b[c]) {
		...
		N = function(a, b, c) {
			a.b || (a.b = {});
			if (!a.b[c]) {
				for (var e = Ya(a, c), d = [], f = 0; f < e.length; f++)
					d[f] = new b(e[f]);
				a.b[c] = d;
			}
			b = a.b[c];
		...
		Ab = function(a) {
			...
			c &&
				...
				v(c, function(a) {
					...
					rb(M(a, Q, 3), b.a) &&
						(a = zb(b, a)) &&
						(b.f.push(a.getId()), (a = N(a, P, 2)) && wb(a));
				}));
		},
		zb = function(a, b) {
			var c = N(b, fb, 2),
	...
	var Db = A(function() {
		...
		T = function(a, b, c, e, d) {
			...
			try {
				f.rel = c;
				if (-1 != c.toLowerCase().indexOf("stylesheet")) var h = ya(b);
				else {
					if (b instanceof B) var n = ya(b);
					else {
						if (b instanceof C)
							var l =
								b instanceof C && b.constructor === C && b.G === za
									? b.l
									: "type_error:SafeUrl";
						else {
							if (b instanceof C) var w = b;
							else
	...
	var Nb = function(a) {
		...
		Ob = function(a, b, c) {
			...
			X();
			1 == c ? a.C() : a.B();
			if (!e && a.F()) Gb(".google.com") && (W[1] = ".google.com"), a.j();
			else {
	...
	Rb.prototype.b = function(a, b, c, e, d) {
		if (Math.random() > (void 0 === c ? 0.01 : c)) return !1;
		(b.error && b.meta && b.id) ||
			(b = new ab(b, { context: a, id: void 0 === d ? "gpt_exception" : d }));
	...
	var Xb = (function(a, b) {
			...
			return function() {
				...
				var d = c(a[ja] || (a[ja] = ++ka), arguments);
	...
	var va = {
		3: [
			...
			[
				...
				[
					[21062676],
					[21062677, [[null, 11, null, [null, 25]]]],
					[21062678, [[null, 11, null, [null, 50]]]],
					[21062679, [[null, 11, null, [null, 75]]]]
				]
			],
			[1, [[21062693], [21062694, [[65, null, null, [1]]]]]],
			[null, [[21062697], [21062698, [[72, null, null, [1]]]]]],
			[
				1,
				[
					[21062717],
			...
			[null, [[21062722], [21062723, [[69, null, null, [1]]]]]],
			...
			[null, [[370204054], [370204055, [[73, null, null, [1]]]]]]
		],
		4: [
		...
		5: [
			...
			[
				...
				[
					[21062689],
					[21062690, [[23, null, null, [1]]]],
					[21062691],
					[21062692, [[23, null, null, [1]]]]
				],
				[12, null, null, null, 2, null, "today\\.line\\.me/.+/article"],
				7
			],
			[
				...
				[
					[
						...
						[
							[null, 7, null, [null, 1]],
							[null, null, 5, [null, null, "21062715"]],
							[null, 12, null, [null, 270]],
							[null, null, 7, [null, null, "21062715"]],
							[60, null, null, [1]],
							[null, null, 6, [null, null, "21062715"]]
						]
					],
					[
						21062716,
						[
							[null, 7, null, [null, 1]],
							[null, 12, null, [null, 271]],
							[null, null, 7, [null, null, "21062716"]],
							[60, null, null, [1]]
						]
					]
				],
			...
			[
				...
				[
					[
						...
						[
							[null, 7, null, [null, 1]],
							[null, null, 5, [null, null, "21062720"]],
							[null, 12, null, [null, 270]],
							[null, null, 7, [null, null, "21062720"]],
							[60, null, null, [1]],
							[null, null, 6, [null, null, "21062720"]]
						]
					],
					[
						21062721,
						[
							[null, 7, null, [null, 1]],
							[null, 12, null, [null, 272]],
							[null, null, 7, [null, null, "21062721"]],
							[60, null, null, [1]]
						]
					]
				],
	...
	var yb = function() {
		...
		var a = this,
			b = Zb.g();
		b[3][6] = function(b) {
			return 0 <= la(a.f, parseInt(b, 10));
		};
		this.a = b;
		D(219).length || H(219, Vb);
		R.g().b = b;
		H(241, b);
		wb(
			oa(D(219), function(a) {
	...
	var $b = z("www.googletagservices.com"),
		ac = function() {
			return D(46) && !D(6)
	...
	(function(a) {
		...
		Tb(b, function() {
			...
			if (e.evalScripts) e.evalScripts();
				...
				if (!(f = b.currentScript))
					a: {
						if ((f = b.scripts))
							for (h = 0; h < f.length; h++) {
								var n = f[h];
								if (-1 < n.src.indexOf($b + "/tag/js/gpt")) {
									f = n;
									break a;
								}
							}
				...
				Ab(7);
				Ab(5);
				S(1, 59, !1) && (H(173, $b), H(174, $b));
				f = D(150);
				X();
				Gb(f) && (W[1] = f);
				d.PerformanceObserver && d.PerformanceLongTaskTiming && Ub(d);
				f = d;
				f = void 0 === f ? m : f;
				...
				e._loadStarted_ ||
					(S(2, 4, 0) || Pb(),
					S(1, 16, !1) && T(b, l, "preload", "script"),
					(d = b.createElement("script")),
					(d.src = l),
					(d.async = !0),
					(b.head || b.body || b.documentElement).appendChild(d),
					S(1, 17, !1) && Db() && T(b, ac(), "preconnect"),
					H(220, !0),
					(e._loadStarted_ = !0));
			}
		});
