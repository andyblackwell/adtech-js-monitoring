			...
			return (function(g, h, j, k) {
				...
				(function() {
					...
					function d() {
						...
						return b != null ? b.max_batch_size : c;
					}
					function e() {
						var c = a.get(null, "batching");
						return c != null ? c.wait_time_ms : b;
					}
					var h = (function() {
						function a(b) {
							m(this, a),
		...
		f.ensureModuleRegistered("SignalsFBEventsCoercePrimitives", function() {
			return (function(g, i, j, l) {
				...
				(function() {
					...
					function o(a) {
						return Array.isArray(a) ? Array.from(a) : null;
					}
					function p(a, b) {
					...
					function q(a, b) {
						a = o(a);
						return a == null ? null : c(d(a, b), Boolean);
					}
					function r(a, b) {
						var c = o(a);
		...
		f.ensureModuleRegistered("SignalsFBEventsConfigStore", function() {
			return (function(g, h, j, k) {
				...
				(function() {
					...
					function o(a) {
						return e(a, {
							enabled_browsers: function(a) {
								return b(a, g);
							},
							max_batch_size: d,
							use_beacon_on_unload: c,
							wait_time_ms: d
						});
					}
					var p = { automaticMatching: n, batching: o, inferredEvents: k };
					a = (function() {
						function a() {
							m(this, a),
								(this._configStore = {
			...
			return (function(g, h, j, k) {
				...
				(function() {
					...
					var a =
						...
						k = f.getFbeventsModules("SignalsFBEventsJSLoader");
			...
			return (function(g, h, i, j) {
				...
				(function() {
					...
					function b(b) {
						b.append("rqm", "SB");
						return g.navigator && g.navigator.sendBeacon
							? g.navigator.sendBeacon(a.ENDPOINT, b.toFormData())
							: !1;
					}
					k.exports = b;
				})();
			...
			return (function(g, h, i, j) {
				...
				(function() {
					...
					function p(a) {
						...
						a = o(a);
						var f = c.get();
						f != null && a.append("exp", f.code);
						if (f != null && f.name === "batching" && f.isInExperimentGroup) {
							e(a);
							b.trigger("BATCH", a, d);
							return;
						}
			...
			return (function(g, h, i, k) {
				...
				(function() {
					...
					var aa = z.fired,
						...
						O;
					h.referrer;
					var P = { PageView: new B(), PixelInitialized: new B() },
						Q = new q(a, N),
						R = new x(Q, G);
					function ha(a) {
					...
					function T(d) {
						...
						switch (d) {
							...
							case "firstPartyCookies":
								...
								if (typeof o === "string")
									Q.callMethod([p, o, "FirstPartyCookies"]);
							...
							case "iwlExtractors":
								var y = f[0],
									z = f[1];
								ea.triggerWeakly({ extractors: z, pixelID: y });
								break;
